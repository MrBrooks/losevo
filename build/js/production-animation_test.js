    ...
    var dairy_products_data = $.getJSON($("div[data-json]").attr("data-json"), function(json){
        ...
        $(".lsv-dairy-products__list-item").click(function(){
          ...
          $("#lsv-dairy-products__menu").toggleClass('active');
    ...
    function initProduct(){
      ...
      if(slidesNumber > 1){
        ...
        $("#lsv-production-product-icon-slider .owl-next").click(function () {
        ...
        $("#lsv-production-product-icon-slider .owl-prev").click(function () {
          if (countBut == 2) {
            countBut = 2;
          } else {
            countBut--;
